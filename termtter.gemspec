Gem::Specification.new do |s|
  ...
  s.files = %w( lib/plugins/april_fool.rb lib/plugins/bomb.rb lib/plugins/clear.rb lib/plugins/confirm.rb lib/plugins/cool.rb lib/plugins/devel.rb lib/plugins/en2ja.rb lib/plugins/english.rb lib/plugins/erb.rb lib/plugins/expand-tinyurl.rb lib/plugins/favorite.rb lib/plugins/fib.rb lib/plugins/fib_filter.rb lib/plugins/filter.rb lib/plugins/graduatter.rb lib/plugins/grass.rb lib/plugins/group.rb lib/plugins/growl.rb lib/plugins/hatebu.rb lib/plugins/history.rb lib/plugins/ignore.rb lib/plugins/keyword.rb lib/plugins/log.rb lib/plugins/me.rb lib/plugins/modify_arg_hook_sample.rb lib/plugins/msagent.rb lib/plugins/multi_reply.rb lib/plugins/notify-send.rb lib/plugins/otsune.rb lib/plugins/outputz.rb lib/plugins/pause.rb lib/plugins/plugin.rb lib/plugins/post_exec_hook_sample.rb lib/plugins/pre_exec_hook_sample.rb lib/plugins/primes.rb lib/plugins/quicklook.rb lib/plugins/random.rb lib/plugins/reblog.rb lib/plugins/reload.rb lib/plugins/reply.rb lib/plugins/reverse.rb lib/plugins/say.rb lib/plugins/scrape.rb lib/plugins/screen-notify.rb lib/plugins/screen.rb lib/plugins/shell.rb lib/plugins/sl.rb lib/plugins/spam.rb lib/plugins/standard_plugins.rb lib/plugins/stdout.rb lib/plugins/storage/DB.rb lib/plugins/storage/status.rb lib/plugins/storage/status_mook.rb lib/plugins/storage.rb lib/plugins/system_status.rb lib/plugins/translation.rb lib/plugins/update_editor.rb lib/plugins/uri-open.rb lib/plugins/url_addspace.rb lib/plugins/wassr_post.rb lib/plugins/yhara.rb lib/plugins/yhara_filter.rb lib/plugins/yonda.rb lib/termtter/api.rb lib/termtter/client.rb lib/termtter/command.rb lib/termtter/config.rb lib/termtter/connection.rb lib/termtter/hook.rb lib/termtter/optparse.rb lib/termtter/system_extensions.rb lib/termtter/task.rb lib/termtter/task_manager.rb lib/termtter/version.rb lib/termtter.rb
                spec/plugin/cool_spec.rb spec/plugin/english_spec.rb spec/plugin/favorite_spec.rb spec/plugin/fib_spec.rb spec/plugin/filter_spec.rb spec/plugin/pause_spec.rb spec/plugin/plugin_spec.rb spec/plugin/primes_spec.rb spec/plugin/shell_spec.rb spec/plugin/sl_spec.rb spec/plugin/spam_spec.rb spec/plugin/standard_plugins_spec.rb spec/plugin/storage/DB_spec.rb spec/plugin/storage/status_spec.rb spec/spec_helper.rb spec/termtter/client_spec.rb spec/termtter/command_spec.rb spec/termtter/config_spec.rb spec/termtter/hook_spec.rb spec/termtter/task_manager_spec.rb spec/termtter/task_spec.rb spec/termtter_spec.rb
